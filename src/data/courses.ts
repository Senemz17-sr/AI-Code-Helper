...
export const COURSES: Course[] = [
  ...
  {
    id: "js-advanced",
    title: "JavaScript - Advanced Patterns & Architecture",
    description:
      "Master design patterns, system architecture, and professional JavaScript development.",
    language: "javascript",
    level: "advanced",
    chapters: 12,
    duration: "6 weeks",
  ...
  },
  {
    ...
    description:
      "Build ML models, work with NumPy, Pandas, and scikit-learn. Advanced Python mastery.",
    language: "python",
    level: "advanced",
    chapters: 14,
    duration: "8 weeks",
